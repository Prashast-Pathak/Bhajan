...
REMEDIES_DATA = [
    {"id": "mangal-dosha", "name": "Mangal Dosha", "hindi": "मंगल दोष", "deity": "Lord Hanuman", "primary_mantra": "Hanuman Chalisa", "explanation": "Mangal Dosha occurs when Mars occupies the 1st, 2nd, 4th, 7th, 8th, or 12th house in the birth chart. It is one of the most commonly checked placements before marriage.", "deep_dive": "Mars represents fire, aggression, logic, and protection. When placed in houses associated with marriage and domestic harmony, its natural fiery disposition can lead to intense friction, misunderstandings, and ego clashes. However, Mangal Dosha is not a curse. It signifies an excess of dynamic energy that must be channeled correctly. Historically, ancient rishis observed that pairing a Manglik with another Manglik balances this fiery energy. Furthermore, the intensity of Mars begins to mature and settle after the age of 28. Remedial measures aim to cool this martian energy through devotion to Lord Hanuman, who perfectly balances immense power with supreme devotion and humility.", "remedies": ["Chant Hanuman Chalisa every Tuesday", "Offer red flowers to Lord Hanuman", "Fast on Tuesdays", "Wear a red coral (Moonga) gemstone after consulting an astrologer", "Donate red lentils or jaggery to the needy"], "cta_text": "Check if you have Mangal Dosha in your Kundali", "cta_link": "https://ournakshatra.com/janam-kundali", "color": "#DC2626"},
    {"id": "kaal-sarp-dosha", "name": "Kaal Sarp Dosha", "hindi": "काल सर्प दोष", "deity": "Lord Shiva", "primary_mantra": "Maha Mrityunjaya Mantra", "explanation": "Kaal Sarp Dosha forms when all planets are hemmed between Rahu and Ketu. It can cause delays in marriage, career struggles, and recurring obstacles.", "deep_dive": "Rahu and Ketu represent the karmic axis of the soul—the head and tail of the cosmic serpent. When all seven visible planets are trapped on one side of this axis, the individual feels a sense of restriction, as if their destiny is heavily constrained by past-life karmas. This dosha often manifests as a life of extremes: sudden rises and sudden falls. Dreams of snakes or ancestors are common. However, many highly successful individuals (including historical leaders and innovators) have had this dosha; it creates intense internal pressure that, if directed through spiritual sadhana, can forge incredible resilience. Lord Shiva, who wears the serpent Vasuki around his neck, is the ultimate pacifier of this intense serpentine energy.", "remedies": ["Chant the Maha Mrityunjaya Mantra 108 times daily", "Perform Abhishek of Shivalinga on Mondays", "Visit Trimbakeshwar Jyotirlinga for Kaal Sarp Shanti Puja", "Donate black sesame seeds on Saturdays", "Float a silver pair of snakes in flowing water"], "cta_text": "Discover if Kaal Sarp Dosha is active in your chart", "cta_link": "https://ournakshatra.com/yogas", "color": "#111827"},
    {"id": "sade-sati", "name": "Shani Sade Sati", "hindi": "शनि साढ़े साती", "deity": "Shani Dev / Lord Shiva", "primary_mantra": "Shani Chalisa", "explanation": "Sade Sati is a 7.5-year period when Saturn transits through three consecutive signs including your Moon sign. It is a time of karmic reckoning, hard work, and deep transformation.", "deep_dive": "The moon represents the mind, emotions, and comfort zone. When the slowest moving and most disciplined planet, Saturn, approaches the Moon, it forces an individual to confront reality without any illusions. The 7.5 years are broken into three phases: the first affects finances and mental peace, the second affects career and physical health, and the third resolves remaining karmic debts before granting maturity and stability. Shani Dev is not malevolent; he is the strict teacher of the zodiac. Those who accept hard work, embrace humility, and let go of ego during this time often emerge with lasting foundations. Remedies focus on service to the underprivileged and intense grounding practices.", "remedies": ["Chant Shani Chalisa every Saturday", "Light sesame oil lamp before Shani Dev on Saturdays", "Feed crows black sesame and mustard oil on Saturdays", "Donate black clothing, iron items, or mustard oil to the poor", "Walk barefoot on grass to ground excess airy energy"], "cta_text": "Check your current Sade Sati status live", "cta_link": "https://ournakshatra.com/transits", "color": "#374151"},
    {"id": "pitru-dosha", "name": "Pitru Dosha", "hindi": "पितृ दोष", "deity": "Pitru Devatas (Ancestors)", "primary_mantra": "Pitru Tarpan", "explanation": "Pitru Dosha occurs due to unfulfilled desires or wrongdoings of ancestors. It manifests as repeated family issues, childlessness, or financial stagnation.", "deep_dive": "In Vedic cosmology, we inherit not just the physical DNA of our ancestors, but their karmic DNA. Pitru Dosha indicates a blockage in the lineage's energetic flow. It is typically seen when the Sun or Moon is afflicted by Rahu or Ketu in the natal chart, especially in the 9th house (house of ancestors). This dosha suggests that souls in your lineage are trapped in the subtle realms, awaiting release. The symptoms are often cyclical—history repeating itself in the family line. By stepping up to perform Tarpan (offering of water) and Shraadh, you act as the spiritual liberator for your bloodline. This self-less act of gratitude removes invisible blockages and restores the flow of ancestral blessings.", "remedies": ["Perform Tarpan on Amavasya (no-moon day)", "Offer water with black sesame seeds to ancestors daily", "Feed Brahmins or the poor on Amavasya", "Perform Shraadh rituals during Pitru Paksha", "Chant the 7th Chapter of the Bhagavad Gita for ancestral peace"], "cta_text": "Check if Pitru Dosha exists in your Kundali", "cta_link": "https://ournakshatra.com/janam-kundali", "color": "#78350F"},
    {"id": "guru-chandal", "name": "Guru Chandal Dosha", "hindi": "गुरु चांडाल दोष", "deity": "Lord Vishnu", "primary_mantra": "Vishnu Sahasranama", "explanation": "Guru Chandal Dosha forms when Jupiter is conjunct or aspected by Rahu. It corrupts one's wisdom, ethics, and can lead a person toward false teachers or immoral paths.", "deep_dive": "Jupiter (Guru) represents divine wisdom, morality, wealth, and higher learning. Rahu represents obsession, illusion, rule-breaking, and materialism. When these two collide, Rahu's smoke clouds Jupiter's pure light. The individual might possess immense intelligence but may use it for manipulative or purely materialistic ends. They might struggle to respect traditional teachers or authority figures, or ironically, might fall prey to fraudulent gurus. The core lesson of this dosha is the purification of the intellect. Healing involves anchoring oneself to timeless, incorruptible wisdom and avoiding ethical shortcuts. Devotion to Lord Vishnu, the preserver of cosmic order (Dharma), helps clear the illusions cast by Rahu.", "remedies": ["Chant Vishnu Sahasranama every Thursday", "Donate yellow items like turmeric and yellow cloth", "Wear a yellow sapphire (Pukhraj) after consulting an astrologer", "Fast on Thursdays and offer prayers to Lord Vishnu", "Respect teachers, elders, and strictly avoid unethical shortcuts"], "cta_text": "Check your Jupiter placement and active Yogas", "cta_link": "https://ournakshatra.com/yogas", "color": "#A8832A"}
]
...
<main class="content-wrapper">
  ...
  <div class="card" style="animation-delay:.05s">
    ...
    <div class="card-body">
      <p class="explanation-text" style="margin-bottom: 18px;">{d['explanation']}</p>
      <p class="explanation-text">{d.get('deep_dive', '')}</p>
    </div>
  </div>
